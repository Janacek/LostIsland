...
BunnyWhite::BunnyWhite(sf::Vector2f &position, int life, Camera *cam)
: Bunny(position, life, cam)
{
	loadAnimation("Media/images/bunny.png", 0.1f);
}

BunnyWhite::~BunnyWhite()
{

}

void BunnyWhite::loadAnimation(std::string const &string_anim, float time)
{
